...
//                            CoreApi.printLog("CarNavigationStatusManager", "######### load onInstrumentClusterStarted -> ${p0 != null}, ${p1}")
                            ...
                            if (p1.supportsCustomImages()){
                                ...
                                p0.sendNavigationTurnEvent(CarNavigationStatusManager.TURN_DEPART/* event */, "Test road name, customizable"/* road */, 0/* turnAngle */, 0/* turnNumber */, customImages/* image */, TurnEvent.TurnSide.RIGHT/* turnSide */)
                            } else {
